...
for kid in data.get_kids():
	...
	teg=entropy_gains.ave_theory_expected_entropy(tlseq)
	reg=entropy_gains.ave_theory_expected_entropy(rlseq)
	keg=entropy_gains.ave_theory_expected_entropy(kidseq)
